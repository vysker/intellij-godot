...
public class GdScriptExtendsStatementImpl extends ASTWrapperPsiElement implements GdScriptExtendsStatement {

  public GdScriptExtendsStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
