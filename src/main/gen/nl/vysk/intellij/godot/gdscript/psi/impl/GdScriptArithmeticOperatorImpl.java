...
public class GdScriptArithmeticOperatorImpl extends ASTWrapperPsiElement implements GdScriptArithmeticOperator {

  public GdScriptArithmeticOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
