...
public class GdScriptCallExpressionImpl extends ASTWrapperPsiElement implements GdScriptCallExpression {

  public GdScriptCallExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
