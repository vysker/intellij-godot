...
public class GdScriptIdentifierTypeImpl extends ASTWrapperPsiElement implements GdScriptIdentifierType {

  public GdScriptIdentifierTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
