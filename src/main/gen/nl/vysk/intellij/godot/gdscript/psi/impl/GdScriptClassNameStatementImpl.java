...
public class GdScriptClassNameStatementImpl extends ASTWrapperPsiElement implements GdScriptClassNameStatement {

  public GdScriptClassNameStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
